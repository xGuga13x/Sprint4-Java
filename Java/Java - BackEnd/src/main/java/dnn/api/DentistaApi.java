...
public class DentistaApi {
    ...
    // Front passa number como id — busca por posição na lista (índice do id retornado)
    // O front usa DentistaService.buscar(id) onde id é o índice da listagem
    // Na prática o front lista e usa o CRO como identificador nos forms
    @GET
    @Path("/{cro}")
